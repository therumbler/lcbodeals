...
async def _parse_product(product_soup):
    ...
    try:
        ...
        raise ValueError('cannot calculate float for price of %s' % price_element.string)
    ...
    image = 'https://www.lcbo.com/content/dam/lcbo/products/{:06d}.jpg/jcr:content/renditions/cq5dam.thumbnail.319.319.png'.format(product_id)
    return {
        'id': url,
        'url': url,
        'title': title,
